                                        ...
                                        @foreach ($questions as $question)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('teacher.quiz.subshow', [$question->category->id, $question->id]) }}"
                                            ...
                                            <div class="modal fade" id="editQuestionModal{{ $question->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form
                                                            action="{{ route('teacher.subjective.update', $question->id) }}"
                                                            method="POST">
                                                            @csrf
                                            ...
                                            <div class="modal fade" id="deleteQuestionModal{{ $question->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form
                                                            action="{{ route('teacher.subjective.delete', $question->id) }}"
                                                            method="GET">
                                                            @csrf
                                                            {{-- @method('DELETE') --}}
                                                            <div class="modal-header">
    ...
    <script>
        $(function() {
            let table = $("#example1").DataTable({
                ...
                language: {
                    search: '',
                    searchPlaceholder: "🔍 Find subjective question..."
                }
            });
