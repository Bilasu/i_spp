                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <!-- Review Results Button -->
                                    <a href="{{ route('admin.quiz.results', ['quiz_id' => $category->id]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($questions as $item)
                                            ...
                                            <div class="modal fade" id="editQuizModal{{ $item->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="{{ route('admin.quiz.update', $item->id) }}"
                                            ...
                                            <div class="modal fade" id="deleteQuizModal{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="{{ route('admin.quiz.delete', $item->id) }}"
                                                            method="GET">
                                                            @csrf
                                                            <div class="modal-header">
                                            ...
                                            {{-- <div class="modal fade" id="reviewResultsModal" tabindex="-1"
                                                aria-labelledby="reviewResultsModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="reviewResultsModalLabel">Review
                                                                Quiz Results</h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- Table to display the quiz results -->
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <!-- You will loop through the quiz results here -->
