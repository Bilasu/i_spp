                ...
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">My Essay Answers List</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                @else
                    ...
                    <div class="card shadow border-0 mb-5">
                        <div class="card-header bg-dark text-white">
                            <h5 class="mb-0"><i class="bi bi-journal-check me-2"></i> List of Your Essay Answers</h5>
                        </div>
                        <div class="card-body">
                            @foreach ($answeredQuestions as $index => $question)
                                ...
                                <div class="card mb-4 shadow-sm border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p><strong>Teahcer' Comment :</strong></p>
    ...
    <script>
        $(function() {
            let table = $("#example1").DataTable({
                ...
                language: {
                    search: '',
                    searchPlaceholder: "🔍 Search essay question..."
                }
            });
