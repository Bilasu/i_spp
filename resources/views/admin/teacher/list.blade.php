                                        ...
                                        @foreach ($users as $item)
                                            <tr>
                                                ...
                                                <td><a href="" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#editTeacherModal{{ $item->ic }}">Edit</a>
                                                </td>
                                            ...
                                            <!-- Edit Modal -->
                                            <div class="modal fade" id="editTeacherModal{{ $item->ic }}" tabindex="-1"
                                                aria-labelledby="editTeacherModalLabel{{ $item->ic }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="{{ route('teacher.update', $item->ic) }}"
                                                            method="POST">
                                                            @csrf
                                                            {{-- @method('PUT') --}}
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="editTeacherModalLabel{{ $item->ic }}">
                                                                    Edit Teacher</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" required
                                        placeholder="Enter your Gmail email" pattern="[a-zA-Z0-9._%+-]+@gmail\.com">
                                </div>
