    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                                    ...
                                    <tbody>
                                        @foreach ($quiz_categories as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('teacher.quiz.read', $item->id) }}">
                                                        {{ $item->name }}
                                                    </a>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="{{ route('teacher.subjective.read', $item->id) }}"
                                                        class="btn btn-outline-success btn-sm rounded-pill">
                                                        ✍️ Paper 2
                                                    </a>
                                                    <a href="{{ route('teacher.essay.read', $item->id) }}"
                                            ...
                                            <div class="modal fade" id="editCategoryQuizModal{{ $item->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form
                                                            action="{{ route('teacher.quizcategory.update', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            {{-- @method('PUT') --}}
            ...
            <div class="modal fade" id="addCategoryQuizModal" tabindex="-1" aria-labelledby="addCategoryQuizModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ route('teacher.quizcategory.store') }}" method="POST">
                            @csrf
                            <div class="modal-header">
